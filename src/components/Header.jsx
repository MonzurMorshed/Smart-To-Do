...
const Header = ({ user }) => {
    ...
    return (
        <header className="relative mb-6 bg-light-primary text-light dark:bg-dark-card flex items-center">
            
            <div className="absolute right-0 top-0 p-4 inline-block text-left">
            ...
            <div className="border-l-[5px] border-[#cbbfd5] pl-5">
                ...
                <p className="text-md font-medium text-body-color">
                    {t('app_subtitle')}
                </p>
            </div>
        </header>
